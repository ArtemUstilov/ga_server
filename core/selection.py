...
def roulette(population, values, final_p_size) -> np.ndarray:
    sum_v = values.sum()
    if sum_v != 0:
...
def tournament_12(population, values, final_p_size) -> np.ndarray:
...
def tournament_4(population, values, final_p_size) -> np.ndarray:
...
def tournament_2(population, values, final_p_size) -> np.ndarray:
